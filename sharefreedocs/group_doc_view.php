...
$numberOfRows = mysql_num_rows(mysql_query("SELECT * FROM upload where approved = 1 AND group_restricted = 1 AND uploaderid!=".$managerID.""));
$totalPages = ceil($numberOfRows / $resultsPerPage);


$sql = mysql_query("SELECT * FROM upload where approved = 1 AND group_restricted = 1 AND uploaderid!=$managerID LIMIT $startResults, $resultsPerPage");
