...
$numberOfRows = mysql_num_rows(mysql_query('SELECT * FROM upload where approved = 0'));
if($numberOfRows == 0){
...
$sql = mysql_query("SELECT * FROM upload where approved = 0 LIMIT $startResults, $resultsPerPage");
