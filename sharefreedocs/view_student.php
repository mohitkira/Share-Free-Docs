...
$numberOfRows = mysql_num_rows(mysql_query("SELECT * FROM upload where approved = 1 AND group_restricted = 0 AND uploaderid!=".$managerID." AND profession= 'student'"));
$totalPages = ceil($numberOfRows / $resultsPerPage);


$sql = mysql_query("SELECT * FROM upload where approved = 1 AND group_restricted = 0 AND uploaderid!=$managerID AND profession= 'student' LIMIT $startResults, $resultsPerPage");
